...
<div class="container">
		...
		<div class="page-header">
			<h2><b>공간 신청 관리게시판</b><br/></h2><hr/><br/>
		</div>
			<c:choose>  
					...
					<c:forEach var = "row" items = "${list}">
						...
						<div class="box2" style = "line-height:140%; ">  
							...
							<c:if test = "${row.APPLY_MODIFY == 'N' }">
								<span style="color:red"><strong>(신규)</strong></span>
								</c:if> 
								<c:if test = "${row.APPLY_MODIFY == 'Y' }">
								<span style="color:blue"><strong>(수정)</strong></span>
								</c:if>
							...
							<br><br/>
							<span class = "space"> 
								<span></span>공간특징 : ${row.APPLY_USE}<br>
							<span class = "address">
								<span></span>주소 : ${row.APPLY_POS}<br>
							<span class = "price"> 
								<span></span> 가격 : ${row.APPLY_PRI}
							</span>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							<input type="button" name="commit" value="승인" style="width:50pt;height:20pt">
							<br><br> 
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
